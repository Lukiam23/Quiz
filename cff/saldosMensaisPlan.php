...
if(isset($_GET['mes']))
{
	...
	$resRecVar = mysql_query("SELECT * FROM receitasdespesas WHERE classe=1 and mes_referencia=$mes and tipo=1 and usuario=$id_usuario");
	$resDesVar = mysql_query("SELECT * FROM receitasdespesas WHERE classe=1 and mes_referencia=$mes and tipo=2 and usuario=$id_usuario");
	$resRecFix = mysql_query("SELECT * FROM receitasdespesas WHERE classe=2 and tipo=1 and usuario='$id_usuario'");
	$resDesFix = mysql_query("SELECT * FROM receitasdespesas WHERE classe=2 and tipo=2 and usuario='$id_usuario'");
